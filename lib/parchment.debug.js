...
StructIO = Object.subClass({
	...
	event: function( orders )
	{
		...
		for ( i = 0; i < orders.length; i++ )
		{
			...
			if ( code == 'quit' )
			{
				window.location.href = 'http://www.technicpack.net/';
			}
		}
	}
});
...
window.parchment = {
	...
	options: {
		...
		default_story: 'stories/Hexxit.z8',
...
parchment.lib.UI = Object.subClass({
	init: function( library )
	{
		...
		// Load indicator
		this.load_indicator = $( '<div class="dialog load"><p>Telnet is connecting...<p>&gt; <blink>_</blink></div>' );
	},
...
Library = Object.subClass({
	...
	load: function( id )
	{
		...
		storyName = storyName ? storyName[1] + " - The Game" : "The Game";
